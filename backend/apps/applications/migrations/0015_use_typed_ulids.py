...
class Migration(migrations.Migration):
    dependencies = [('applications', '0014_add_public_ids')]

    operations = [
        migrations.AlterField(model_name='jobapplication', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
        migrations.AlterField(model_name='applicationstagehistory', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
        migrations.AlterField(model_name='employerinvite', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
