...
urlpatterns = [
    ...
    path('job-offers/<int:offer_id>/approve/', JobOfferApproveAPIView.as_view(), name='job-offer-approve'),
    path('job-offers/<int:offer_id>/disapprove/', JobOfferDisapproveAPIView.as_view(), name='job-offer-disapprove'),
    path('job-offers/<int:offer_id>/resubmit/', JobOfferResubmitAPIView.as_view(), name='job-offer-resubmit'),
    path('job-offers/<int:offer_id>/send/', JobOfferSendAPIView.as_view(), name='job-offer-send'),
