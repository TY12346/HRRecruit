...
class Migration(migrations.Migration):
    dependencies = [('billing', '0006_add_public_ids')]

    operations = [
        migrations.AlterField(model_name='subscriptionplan', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
        migrations.AlterField(model_name='subscription', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
        migrations.AlterField(model_name='payment', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
