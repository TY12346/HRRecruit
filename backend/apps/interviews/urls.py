...
urlpatterns = [
    ...
    path('availability/patterns/<str:pattern_id>/', InterviewerAvailabilityPatternDetailAPIView.as_view(), name='interviewer-availability-pattern-detail'),
    ...
    path('availability/unavailable-dates/<str:unavailable_date_id>/', InterviewerUnavailableDateDetailAPIView.as_view(), name='interviewer-unavailable-date-detail'),
    path('availability/', InterviewerAvailabilitySlotListCreateAPIView.as_view(), name='interviewer-availability-list-create'),
    path('availability/<str:slot_id>/', InterviewerAvailabilitySlotDetailAPIView.as_view(), name='interviewer-availability-detail'),
    path('scheduling-requests/', InterviewSchedulingRequestListAPIView.as_view(), name='interview-scheduling-request-list'),
    path('scheduling-requests/<str:scheduling_request_id>/book/', BookSchedulingRequestAPIView.as_view(), name='interview-scheduling-request-book'),
    path('<str:interview_id>/', InterviewDetailAPIView.as_view(), name='interview-detail'),
    path('<str:interview_id>/recordings/', InterviewRecordingUploadAPIView.as_view(), name='interview-recording-upload'),
    path('<str:interview_id>/evaluations/', InterviewEvaluationSubmitAPIView.as_view(), name='interview-evaluation-submit'),
    path('<str:interview_id>/evaluation-detail/', InterviewEvaluationDetailAPIView.as_view(), name='interview-evaluation-detail'),
]
