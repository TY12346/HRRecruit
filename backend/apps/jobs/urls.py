...
urlpatterns = [
    ...
    path('requisitions/<int:requisition_id>/', JobRequisitionDetailAPIView.as_view(), name='job-requisition-detail'),
    path('requisitions/<int:requisition_id>/cancel/', JobRequisitionCancelAPIView.as_view(), name='job-requisition-cancel'),
    ...
    path('<int:job_id>/ranked-applicants/', RankedApplicantsAPIView.as_view(), name='job-ranked-applicants'),
]
