...
class Migration(migrations.Migration):
    dependencies = [('organizations', '0003_add_public_ids')]

    operations = [
        migrations.AlterField(model_name='organization', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
        migrations.AlterField(model_name='organizationmembership', name='public_id', field=models.CharField(editable=False, max_length=30, unique=True)),
