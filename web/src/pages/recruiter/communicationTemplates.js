  ...
  manual_interview_assignment: [
    {
      ...
      tone: 'Internal',
      body: 'Please review {{applicantName}} for {{jobTitle}}. Focus on role fit, communication, and the key requirements configured for this job. Add evaluation notes after the interview.',
    },
  ],
  rejection: [
    {
    ...
    },
    {
      ...
      tone: 'Respectful',
      body: 'Hi {{applicantName}},\n\nThank you for taking the time to interview for {{jobTitle}}. After reviewing the interview feedback, we have decided to proceed with other applicants whose experience more closely matches the current role requirements. We appreciate your time and interest in {{companyName}}.\n\nBest regards,\n{{recruiterName}}',
    },
  ],
  offer: [
    {
...
export function buildApplicationTemplateContext(application = {}, overrides = {}) {
  ...
  return {
    applicantName: applicant.full_name ?? application.applicant_name ?? DEFAULT_CONTEXT.applicantName,
